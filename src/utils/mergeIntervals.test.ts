...
import { mergeIntervals, totalMinutesRoundedUp, type Interval } from './mergeIntervals'
...
describe('mergeIntervals', () => {
  ...
  it('ignores intervals with null end', () => {
    expect(mergeIntervals([{ start: '2025-01-01T10:00:00.000Z', end: null }])).toEqual([])
  })
...
describe('totalMinutesRoundedUp', () => {
  it('returns 0 for no closed intervals', () => {
    ...
    expect(totalMinutesRoundedUp([{ start: '2025-01-01T10:00:00.000Z', end: null }])).toBe(0)
  })
