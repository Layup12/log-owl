...
- **Vitest** — юнит‑тесты для бизнес‑логики, утилит и части Electron‑кода.
- **Husky + lint-staged**:
  - на pre-commit гоняются линтер, форматтер, spellcheck и тесты только по изменённым файлам;
