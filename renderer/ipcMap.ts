...
// Value exists only for typeof ipcMap → IpcMap; not used at runtime
...
const ipcMap = {
  ...
  [CHANNELS.TASK_UPDATE]: {
    args: [0, {} as TaskUpdatePayload],
    result: undefined as void,
  },
  [CHANNELS.TASK_DELETE]: { args: [0], result: true as boolean },

  [CHANNELS.TASK_SESSION_GET_ALL]: {
    args: [] as const,
    result: [] as TaskSession[],
  },
  [CHANNELS.TASK_SESSION_GET_BY_ID]: {
    args: [0] as [number],
    result: null as TaskSession | null,
  },
  [CHANNELS.TASK_SESSION_GET_BY_TASK_ID]: {
    args: [0] as [number],
    result: [] as TaskSession[],
  },
  [CHANNELS.TASK_SESSION_CREATE]: {
    args: [{} as TaskSessionCreatePayload],
    result: {} as TaskSession,
  },
  [CHANNELS.TASK_SESSION_UPDATE]: {
    args: [0, {} as TaskSessionUpdatePayload],
    result: undefined as void,
  },
  ...
  [CHANNELS.TIME_ENTRY_GET_ALL]: {
    args: [] as const,
    result: [] as TimeEntry[],
  },
  [CHANNELS.TIME_ENTRY_GET_BY_ID]: {
    args: [0] as [number],
    result: null as TimeEntry | null,
  },
  [CHANNELS.TIME_ENTRY_GET_BY_TASK_ID]: {
    args: [0] as [number],
    result: [] as TimeEntry[],
  },
  [CHANNELS.TIME_ENTRY_CREATE]: {
    args: [{} as TimeEntryCreatePayload],
    result: {} as TimeEntryCreateResult,
  },
  [CHANNELS.TIME_ENTRY_UPDATE]: {
    args: [0, {} as TimeEntryUpdatePayload],
    result: undefined as void,
  },
  ...
  [CHANNELS.SETTINGS_GET_ALL]: {
    args: [] as const,
    result: [] as SettingsGetAllResult[],
  },
  ...
  [CHANNELS.APP_GET_RECOVERY_INFO]: {
    args: [] as const,
    result: {} as RecoveryInfo,
  },
